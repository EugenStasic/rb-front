        ...
        <Container fluid >
            <Row>
                ...
                <Col md={9} lg={10} style={{ paddingLeft: '12vh'}}>
                    <h1 className="mb-3" style={linkStyle}>My Boats</h1>
                    <div className="d-flex mb-3">
                        <button className="btn btn-primary me-2" onClick={() => navigate('/registerboat')}>Add New Boat</button>
                        <button className="btn btn-primary me-2" onClick={() => navigate('/my-boat-bookings')}>My Boat Bookings</button>
                    </div>
                    <div className="row">
                        {boats.map(boat => (
